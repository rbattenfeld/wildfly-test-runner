...
@Managed(jbossHomeParent = "./target", startupTimeout = 3000, overwrite = false, zipFile = "C:/Users/tkba2/Downloads/wildfly-10.0.0.Final.zip", adminPort = 10090, javaOpts = "-Djboss.socket.binding.port-offset=100")
@DeploymentClass(deploymentClass = "com.six_group.java_ee.common.junit.test.DeploymentCreator")
public class PojoManaged2ITCase {
