...
@Managed(jbossHomeParent = "./target", 
         ...
         cliScript = "")
@DeploymentClass(deploymentClass = "com.six_group.java_ee.common.junit.test.asWarArchiveWithContext.WarDeploymentCreator")
public class WarDeploymentWithContextITCase {
